...
<section class="main-content">				
		...
		<div class="controls">
			<input type="text" name='nama' value='<?php=$data->nama?>'class='required'
			>
		</div>
	</div>
	<div class="control-group">
	...
	<div class="control-group">
		<label class="control-label" >email</label>
		<div class="controls">
			<input type="text" name='email' id='email' value='<?php=$data->email?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		<label class="control-label" >Password</label>
		<div class="controls">
			<input type="password" name='password' id='password' value='<?php=$data->password?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='telp' id='telp' value='<?php=$data->telp?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='kota' id='kota' value='<?php=$data->kota?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name='kodepos' id='kodepos' value='<?php=$data->kodepos?>' class='required'
			>
		</div>
	</div>
	<div class="control-group">
